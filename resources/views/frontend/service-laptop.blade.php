                            ...
                            <fieldset>
                                <div class="service">
                                    <div class="col-lg-12 col-md-12" data-aos="fade-up" data-aos-delay="300">
                                        <form action="{{route('transaksi.laptop')}}" method="post">
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group mt-2">
                                                <label class="subtitle2">Type/Jenis Laptop</label>
                                                <input type="text" name="type" class="form-control"
                                                    placeholder="Type/Jenis Laptop Anda" required>
                                            </div>
                                            <div class="form-group" id="data-0">
                                                <label class="subtitle2">Kerusakan Laptop</label>
                    ...
                    <div id="banner" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active ">
                                <img src="{{ asset('frontend/assets/img/laptop.jpg')}}" class="d-none d-sm-block w-100"
                                    alt=AC Cleaning>
                            </div>
